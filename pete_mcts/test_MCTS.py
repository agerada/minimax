...
def test_itt2():
    ...
    # from node 2. This means that nodes 0 and 2 have been visited twice and
    # once respectively.

    mcts.run_itt(node=(0,))
    assert mcts.nodes_and_chldn == {(0,): [(1,), (2,)],
                                    (2,): [(5,), (6,)]}
    assert mcts.N == {(0,): 2, (4,): 1, (2,): 1, (5,): 1}


def test_itt3():
    # On the third iteration (with random seed fixed) rollout has to be
    # conducted from node 1.
